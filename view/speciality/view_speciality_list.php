<script type="text/javascript" src="../js/speciality.js?rev=<?php echo time();?>"></script>
<div class="col-md-12">
    <div class="box box-warning box-solid">
        <div class="box-header with-border">
              <h3 class="box-title">MANTENIMIENTO DE ESPECIALIDADES MÉDICAS</h3>
            ...
            <div class="form-group">
              ...
              <table id="speciality_table" class="display responsive nowrap" style="width: 100%">
                <thead>
                  <tr>
                    <th>#</th>
                    <th>Especialidad</th>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="col-lg-12">
            ...
            <input type="text" class="form-control" id="txtName" placeholder="Ingrese nombre de la especialidad"><br>
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="col-lg-12">
            ...
            <input type="text" class="form-control" id="txtNewNameEdit" placeholder="Ingrese nombre de la especialidad"><br>
          </div>
